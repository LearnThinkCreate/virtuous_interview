# AUTOGENERATED! DO NOT EDIT! File to edit: ../04_Gpt_Solution.ipynb.

# %% auto 0
__all__ = ['credit_card_prompt', 'CreditCardCleaner', 'values_to_replace', 'gift_type_prompt', 'GiftTypeCleaner', 'df', 'gpt_response', 'GptPrompt', 'to_csl']

# %% ../04_Gpt_Solution.ipynb 3
import pandas as pd
import openai
import pandas_gpt
import json
...
# %% ../04_Gpt_Solution.ipynb 4
openai.api_key = dotenv_values()['OPENAI_API_KEY']

# %% ../04_Gpt_Solution.ipynb 6
class GptPrompt:
