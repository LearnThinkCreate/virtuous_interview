...
# %% auto 0
__all__ = ['DB_NAME', 'DB_USER', 'DB_PASSWORD', 'tables', 'engine', 'add_column', 'insert_contact_type', 'update_zip',
           'update_deceased', 'update_gift_type', 'proc', 'insert_sql', 'insert_proc']
